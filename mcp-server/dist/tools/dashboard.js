...
export const dashboardTools = [
    {
        ...
        handler: async () => {
            try {
                ...
                const [customerCount, activeCustomerCount, orderCount, pendingOrderCount, productCount, allProducts, supplierCount, activeSupplierCount, followUpCount, overdueFollowUpCount, monthlyRevenue, totalRevenue, recentOrders, recentFollowUps, customerByLevel,] = await Promise.all([
                ...
                const stats = {
                    ...
                    订单: {
                        ...
                        最近订单: recentOrders.map((o) => ({
                            订单号: o.orderNo,
                            客户: o.customer.companyName,
                            金额: formatCurrency(o.totalAmount),
                            状态: o.status,
                        })),
                    },
                    产品: {
                    ...
                    跟进: {
                        ...
                        最近需跟进: recentFollowUps.map((f) => ({
                            客户: f.customer.companyName,
                            事项: f.followUpMatters,
                            优先级: f.priority,
                            下次跟进: f.nextFollowUpDate ? new Date(f.nextFollowUpDate).toISOString().split('T')[0] : '—',
                        })),
                    },
                };
                return {
